...
const core=['parser','spatial','project','encoder','sources','project-view','history','view-filter'];
const web=['app','map','record-list','i18n','storage','source-cache','autosave','worker','worker-session','worker-client','details','downloads','export-dialog'];
