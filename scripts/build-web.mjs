import { mkdir,copyFile,readdir,unlink,writeFile,lstat } from 'node:fs/promises';
...
export async function buildWeb({outputDir=dist,canardDir=null}={}){
...
console.log(`Built ${files.length} allowlisted assets and ${Object.keys(dataset).length} CANARD files`);
}
