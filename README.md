...
Country exports: the [written country-export design](docs/superpowers/specs/2026-09-20-country-export-design.md) is approved. The [six-task implementation plan](docs/superpowers/plans/2026-09-20-country-export.md) awaits review before native execution. It preserves full project backups and complete linked cross-border OPP sections, requires uncertainty review, retains source notices and keeps existing BIN safety checks. No country-export feature is implemented yet.
