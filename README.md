...
**[Open MiVue TrafficCam](https://szkocot.github.io/mivue-trafficcam/)** — published and live-browser verified on 2026-09-20. PL/EN, official database loading, local file editing/export and CSV/GeoJSON imports are available. [Deployment workflow and safety notes](docs/deployment.md). Live CANARD imports and country filtering are not yet available. **Use at your own risk; MiVue 955W device acceptance is untested.**
...
The [hosted CANARD snapshot spec](docs/superpowers/specs/2026-09-20-canard-snapshot-design.md) and [eight-task implementation plan](docs/superpowers/plans/2026-09-20-canard-snapshot.md) are approved for native execution. Task 1 adds tested bounded public-page retrieval and a [verified field inventory](docs/canard-field-inventory.md). Current arrays contain 499 point-speed, 138 OPP and 169 red-light records; the control-point layer has no usable IDs/coordinates and must not be called a verified empty dataset. Publication stays disabled pending usable control-point evidence or an explicitly approved coverage change. The browser connector, hosted cache and publisher are not yet implemented.
