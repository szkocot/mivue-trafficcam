...
The [hosted CANARD snapshot spec](docs/superpowers/specs/2026-09-20-canard-snapshot-design.md) is approved. It covers daily validated updates, download-on-change caching, protected automatic merges for opted-in projects, bilingual freshness notices and attribution. The [eight-task implementation plan](docs/superpowers/plans/2026-09-20-canard-snapshot.md) is written and awaiting review and execution-method selection. Implementation and publication have not started.
