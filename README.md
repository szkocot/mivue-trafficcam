...
Country exports: the user approved an export-only selector and retaining complete linked cross-border OPP sections with warnings. The [written country-export design](docs/superpowers/specs/2026-09-20-country-export-design.md) is awaiting review before implementation planning. It preserves the full project backup, requires uncertainty review, retains source notices and keeps all existing BIN safety checks. No country-export feature is implemented yet.
