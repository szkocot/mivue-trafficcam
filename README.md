...
The [hosted CANARD snapshot spec](docs/superpowers/specs/2026-09-20-canard-snapshot-design.md) is written and awaiting user review. It covers daily validated updates, download-on-change caching, protected automatic merges for opted-in projects, bilingual freshness notices and attribution. The conversational design is approved; the written spec and implementation plan still require review before implementation.
